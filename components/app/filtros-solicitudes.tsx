  ...
  return (
    <form onSubmit={handleFilter} className="flex flex-wrap items-end gap-3 mb-6 p-4 rounded-xl border bg-card text-card-foreground shadow-sm">
      <div className="flex flex-col gap-1.5">
        <label htmlFor="estado" className="text-xs font-semibold text-muted-foreground flex items-center gap-1.5 select-none">
        ...
        <select
          ...
          className="flex h-9 rounded-md border border-input bg-background px-3 py-1 text-sm shadow-sm transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-amber-500 w-full sm:w-[180px] text-foreground cursor-pointer hover:border-accent-foreground/35"
        >
      ...
      <div className="flex gap-2 w-full sm:w-auto">
        ...
        {(defaultEstado || defaultDesde || defaultHasta) && (
