-- ============================================================
-- Migración 21 · Formatear nombre del insumo con presentación y unidad
-- ------------------------------------------------------------
-- Redefine los stored procedures de insumos, ingresos, egresos,
-- solicitudes, inventario, historial y reportes para que el nombre
-- del insumo se visualice siempre como "Nombre Presentación Unidad".
-- ============================================================
...
-- ------------------------------------------------------------
-- 6. sp_listar_solicitudes_pendientes
-- ------------------------------------------------------------
